...
Read the README_multibody_parts_core.txt file to learn more.
Open the project by double-clicking on Multibody_Parts_Core.prj
...
To see all the examples, open project Multibody_Parts_Library.prj, which 
includes this project as a Reference Project.  If you wish to include these parts
...
v 3.0 (R2019a)	Mar  2019   Updated for new release
