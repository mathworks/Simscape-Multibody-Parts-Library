...
% geometry, material, and appearance.  Information on individual parts is
% shown below.
%
% A full set of examples is available in project
% Multibody_Parts_Library.prj.  Here are some test models included in this
% project:
% 
% <html>
